...
pure subroutine PackMatrix(A, N, M, NotNullRows, NotNullCols)
   ...
   ! MatMul - составили матрицу (N,M) из логических значений - проверка /= 0
   ! Pack - возвращает одномерный массив: Array of rank one (применяет маску к A)
   ! Reshape - преобразуем одномерный массив в двумерный массив с размером [N, M]
