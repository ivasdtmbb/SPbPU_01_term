...
program reference_lab_1_1
   ...
   ! Массивы фамилий, инициалов, полов, оценок и средних оценок и временные
   ...
   !end do
   !
   ! 5. Можно использовать расширение над стандартом:
   !   read (In, '(3(a, 1x), <MARKS_AMOUNT>i1, f5.2)', iostat=IO) (Surnames(i), Initials(i), Gender(i), Marks(i, :), i = 1, STUD_AMOUNT)
